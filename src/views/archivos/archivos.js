...
import ArchivosAddForm from "./ArchivosAddForm"
// core components
          ...
          <Row>
            <Col xs="12">
              <Card className="card-chart">
                <CardHeader>
                  <Row>
                    <Col className="text-left" sm="6">
                      <h5 className="card-category">Archivos</h5>
                      <CardTitle tag="h2">SUBIR</CardTitle>
                    </Col>
                    <Col sm="6">
                      <ButtonGroup
                ...
                <CardBody>
                  <div >
                    <ArchivosAddForm classes={classes} classesM={classesM} setMsg={setMsg} setColor={setColor} ID={ID} nombre={""}
                    folio={""} descripcion={""} seccion={''} asunto={''} obs={""}
                    bandEdit={true} />                 
                    {/*<Line
